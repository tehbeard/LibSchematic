...
/**
 * An implementation of a schematic rotation handler That uses the
 * ForgeDirection class to handle rotation on blocks using that.
 * 
 * @author James
 * 
 */
public class ForgeDirectionRotationHandler extends SimpleRotationHandler {
    ...
    public int rotateData(SchematicFile schematic, int x, int y, int z,
        ...
        return fdRotate(ForgeDirection.values()[rotate], rotations).ordinal()
                | extraData;
    }
