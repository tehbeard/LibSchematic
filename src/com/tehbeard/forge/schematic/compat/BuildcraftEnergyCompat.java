    ...
    public void postInit(FMLPostInitializationEvent event) {
        if (Loader.isModLoaded("BuildCraft|Energy")) {
            SchematicDataRegistry.logger().info(
                    "Installing BuildCraft|Energy handler");
            ...
            TileEntityRotationHandler engineRotation = new TileEntityRotationHandler() {
                ...
                public void rotateTileEntity(SchematicFile schematic, int x,
                    ...
                    if (tileEntity instanceof TileEngine == false) {
                        SchematicDataRegistry
                                .logger()
                                .warning(
                                        "CALLED ENGINE ROTATION CODE ON NON ENGINE BLOCK");
                        return;
                    }
            ...
            SchematicDataRegistry.setHandler(
                    BuildCraftEnergy.engineBlock.blockID, engineRotation);
        }
    }
}
