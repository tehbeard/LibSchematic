 ...
 *
 */
public abstract class TileEntityRotationHandler implements SchematicRotationHandler {

	@Override
	public int rotateData(SchematicFile schematic, int x, int y, int z,
			int blockId, int metadata, int rotations) {return metadata;}

	@Override
	public abstract void rotateTileEntity(SchematicFile schematic, int x, int y, int z,
